      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-white/70 backdrop-blur-sm border border-purple-100 rounded-3xl p-8 h-full hover:bg-white/90 hover:border-purple-200 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                <div className="text-center">
                  <div className="bg-purple-100 p-4 rounded-2xl w-fit mx-auto mb-6 group-hover:bg-purple-200 transition-colors">
                    <step.icon className="w-8 h-8 text-purple-600" />
                  </div>
                  
                  <div className="text-5xl font-bold text-purple-200 mb-4">{step.step}</div>
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-1/2 -right-4 w-8 h-px bg-gradient-to-r from-purple-300 to-transparent transform -translate-y-1/2 z-10" />
              )}
            </motion.div>
          ))}
        </div>
