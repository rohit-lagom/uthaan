  ...
  return (
    <section className="py-20 relative bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 right-1/3 w-80 h-80 bg-green-200/20 rounded-full mix-blend-multiply filter blur-3xl" />
        <div className="absolute bottom-1/3 left-1/4 w-96 h-96 bg-emerald-200/20 rounded-full mix-blend-multiply filter blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6">
            Road to <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Ecosystem</span>
          </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className={`lg:w-1/2 ${isEven ? 'lg:pr-12' : 'lg:pl-12'}`}>
                    <div className={`bg-white/60 backdrop-blur-xl border ${colors.border} rounded-3xl p-8 group hover:bg-white/80 hover:border-white/30 transition-all duration-300 shadow-2xl hover:shadow-3xl`}>
