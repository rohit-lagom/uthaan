...
const Platform = () => {
  ...
  const platformModules = [
    {
      icon: <HiOutlineCurrencyDollar className="w-12 h-12 text-white" />,
      title: 'Token Layer',
    ...
    {
      icon: <HiOutlineShoppingCart className="w-12 h-12 text-white" />,
      title: 'Smart Marketplace',
      description: 'P2P crop trading, escrow-based payments',
    },
    {
      icon: <HiOutlineGlobe className="w-12 h-12 text-white" />,
...
>
  {platformModules.map((module, index) => (
    <motion.div
      ...
      className="w-full sm:w-[48%] bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-xl p-8 flex flex-col items-center text-center transition-all duration-300 hover:shadow-2xl"
    >
      <div className="bg-white/10 p-4 rounded-full mb-6 border border-white/20 shadow-sm">
        {module.icon}
      </div>
      ...
      <p className="text-white/90">{module.description}</p>
        ...
        <div className="mt-12 text-center">
          <motion.a
            ...
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl font-medium text-white bg-white/10 border border-white/30 backdrop-blur-md hover:bg-white/20 hover:shadow-lg transition-all duration-200"
          >
